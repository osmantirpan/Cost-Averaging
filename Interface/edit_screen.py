...
class edit_screen(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.qline_edit_warn_label.setText("This field cannot be empty")
        self.qline_edit_warn_label.setStyleSheet("background-color:red")
        self.qline_edit_warn_label2.setText("Enter only alphabetic characters..")
        self.qline_edit_warn_label2.setStyleSheet("background-color:red")
        self.qline_edit1_label.setText("Enter asset name..")
