...
class edit_screen2(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.edit_sc_success_label.setText("Ürün başarıyla eklendi..")
        self.edit_sc_warn_label.setText("Lütfen tüm alanları doldurunuz")
        self.edit_sc_warn_label2.setText("Lütfen sayısal değer giriniz..")
        ...
        self.qline_edit1_label1.setText("Tarihi Giriniz..")
